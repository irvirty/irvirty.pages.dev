...
//var myCacheVersion = "v.1.2.2025.08.22";
...
e.waitUntil(caches.open("v.1.2.2025.08.22").then((cache) => cache.addAll(fileListArrFound)),);
});*/
...
"/pages/website-mini-templates/why-underline-important-aut-light-dark-1/index.html",
"/pages/website-mini-templates/why-underline-important-aut-light-dark-1/",
"/pages/website-mini-templates/why-underline-important-aut-light-dark-1/style.css",
...
this.addEventListener("activate", (event) => {
  const cachesToKeep = ["v.1.2.2025.08.22"];
