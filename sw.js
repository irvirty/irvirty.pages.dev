...
//var myCacheVersion = "v.1.2.2025.09.24";
...
e.waitUntil(caches.open("v.1.2.2025.09.24").then((cache) => cache.addAll(fileListArrFound)),);
});*/
...
"/pages/wordpress-themes/simplehomepage/simplehomepage (copy 2).zip",
...
this.addEventListener("activate", (event) => {
  const cachesToKeep = ["v.1.2.2025.09.24"];
