...
//var myCacheVersion = "v.1.2.2025.09.03";
...
e.waitUntil(caches.open("v.1.2.2025.09.03").then((cache) => cache.addAll(fileListArrFound)),);
});*/
...
"/pages/firefox-extensions/irvirty-search-10/icon512x512.png",
"/pages/firefox-extensions/irvirty-search-10/",
...
this.addEventListener("activate", (event) => {
  const cachesToKeep = ["v.1.2.2025.09.03"];
