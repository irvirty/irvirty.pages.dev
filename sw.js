...
//var myCacheVersion = "v.1.2.2026.02";
...
e.waitUntil(caches.open("v.1.2.2026.02").then((cache) => cache.addAll(fileListArrFound)),);
});*/
...
this.addEventListener("activate", (event) => {
  const cachesToKeep = ["v.1.2.2026.02"];
