...
//var myCacheVersion = "v.1.2.2026.09";
...
e.waitUntil(caches.open("v.1.2.2026.09").then((cache) => cache.addAll(fileListArrFound)),);
});*/
...
"/projects/keep-1/script (copy 5).js",
...
this.addEventListener("activate", (event) => {
  const cachesToKeep = ["v.1.2.2026.09"];
