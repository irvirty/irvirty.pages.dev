var sitemapJsonVar = [
    ...
    {
        "text": "Binary Clock\n\nBinary clock online on webpage. Made with CSS and JavaScript. | time binary clock: ",
    ...
    {
        "text": "CSS Animation Test\n\nCSS animation demonstration. | animation test: ",
    ...
    {
        "text": "Close() JS\n\nClose() JS. test close tab. | exit: ",
        "url": "\/old-projects\/exit-80\/index.html",
        "tag": " #HTML #CSS #JavaScript #project",
        "id": "8a3a7d792b11132fda3e7b8819469e3f",
        "time": "id"
    },
    {
    ...
    {
        "text": "Language learning quiz\n\nLanguage learning quiz. Language quiz. Quiz word. It is necessary to choose the correct version of the translated word. | language quiz: ",
        "url": "\/games\/language-quiz-45\/index.html",
        "tag": " #Experimental #learning #language #game #quiz #word #CSS #JavaScript #project",
        "id": "d4b4965e21f083a386b69bbe518e044f",
        "time": "id"
    },
    {
    ...
    {
        "text": "Old projects\n\nOn this page are the projects that are outdated. | old projects: ",
    ...
    {
        "text": "Show hide when resize using CSS\n\nShow hide item when resize using CSS. | hide show on resize: ",
    ...
    {
        "text": "Sitemap\n\nSite map with all pages or search on the site. (Static search based on JavaScript and JSON data in the variable). | sitemap: ",
    ...
    {
        "text": "Start Page\n\nStart page, home page, new tab page. Timer in tab. Tab timer. | start page: ",
        "url": "\/projects\/start-page-41\/index.html",
        "tag": " #Timer #NewTabPage #StartPage #home #homepage #start #page #tab #NewTab #StartPage #CSS #JavaScript #project",
    ...
    },
    {
        ...
        "id": "3a7f54a1036b45a8ac9f0ea8982a2468",
        "time": "id"
    },
    {
    ...
    },
    {
        ...
        "tag": " #sandbox #UI #UX #landing #webpage #website #page #site #webdesign #web #design #webdevelopment #development #template #templates #SaaS #personal #profile #card #HomePage #cards #project #list #page #main",
