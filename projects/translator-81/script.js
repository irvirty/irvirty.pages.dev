...
// run translate
fuTranslate(tFrom, tTo, tQ, wordJsonVar, "translated");
...
textareaElement.addEventListener('input', function(event) {
    // 3. Access the current value using event.target.value or textareaElement.value
    const currentValue = event.target.value;
fuTranslate(tFrom, tTo, currentValue, wordJsonVar, "translated");
});
*/
